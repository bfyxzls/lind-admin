...
public interface DictService {
     ...
     * 分页查询字典类型
     */
    PageResult<DictType> findTypePage(String dictName, String dictType, Integer status, Integer pageNum, Integer pageSize);
     ...
     * 分页查询字典数据
     */
    PageResult<DictData> findDataPage(String dictType, String dictLabel, Integer status, Integer pageNum, Integer pageSize);
